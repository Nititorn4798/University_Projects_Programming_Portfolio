...
<?php
    ...
    if (isset($_POST["submit"]) && !empty($_POST["product_name"]) && !empty($_POST["product_price"])
        ...
        if ($product_image_path != "") {
            ...
            product_type = '$product_type',product_status = '$product_status',product_description = '$product_detail',product_image_path = '$product_image_path' WHERE product_id = $product_id";
        } else {
            $cmd = "UPDATE products SET
            product_name = '$product_name',product_price = '$product_price',product_quantity = '$product_quantity',
            product_type = '$product_type',product_status = '$product_status',product_description = '$product_detail' WHERE product_id = $product_id";
        }
